...
env = retro.make(game=rom_path,state="Level1-99",inttype=retro.data.Integrations.CUSTOM_ONLY)
...
lr_schedule = linear_schedule(4.12e-05)

# model=PPO.load("best_model_1430000")
